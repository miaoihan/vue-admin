...
<template>
  <div class="home-page">
    ...
    <el-card class="box-card">
      <div slot="header">
        <span>富文本编辑器DEMO</span>
      </div>
      <el-row>
        <zy-rich-editor ref="htmlEditor" @editor-updated="handleEditorUpdatedContent">
        </zy-rich-editor>
      </el-row>
    </el-card>
  ...
  export default {
    ...
    methods: {
      ...
      setEditorContent: function () {
        this.$refs.htmlEditor.setContent('<h1>Html For <a href="#">good2</a> Editor</h1>')
      },
      // 通过富文本的更新事件获取html代码
      handleEditorUpdatedContent (value) {
        this.htmlContentSample = value
        console.log(this.htmlContentSample)
      },
      getStats: function () {
